...
print()
print("  7. Every result (including errors) has domain_age_days, domain_age_label,")
print("     and domain_age_note fields. google.com / example.com should show")
print("     domain_age_label='established' with a note citing the registration year.")
print()
print("  8. The malware URL case still returns verdict='dangerous' — domain age")
print("     must NOT change the verdict, only the age fields.")
